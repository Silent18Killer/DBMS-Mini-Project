...
CREATE TABLE callrecords (
  CallId int NOT NULL,
  CallStartTime varchar2(15) NOT NULL,
  CallEndTime varchar2(15) NOT NULL,
  CallDuration varchar2(15) NOT NULL,
...
(
  ...
  PRIMARY KEY (OrderId),
  CONSTRAINT OrderCustomerId FOREIGN KEY (OrderCustomerId) REFERENCES customer (CustomerId)
);
...
(
  ...
  CONSTRAINT SimCustomerId FOREIGN KEY (SimCustomerId) REFERENCES customer (CustomerId),
